        ...
        <div className="container">
          <div className="Tariffs" id="tariffs">
            <h2 className="section-header">
              <FormattedMessage id="nav.tariffs" defaultMessage="Tariflər" />
            </h2>
            <div
              className={
            ...
            >
              <div className="Tariffs-card">
                <h3>
                  <FormattedMessage
                    id="tariffs.zone1.header"
                    defaultMessage="Zona 1."
                  />
                </h3>
                <p>
                  <FormattedMessage
                    id="tariffs.zone1.text"
                    defaultMessage="Sahil m/s, İçəri Şəhər m/s, 28 may m/s, Nizami m/s, Elmlər
              ...
              <div className="Tariffs-card">
                <h3>
                  <FormattedMessage
                    id="tariffs.zone2.header"
                    defaultMessage="Zona 2."
                  />
                </h3>
                <p>
                  <FormattedMessage
                    id="tariffs.zone2.text"
                    defaultMessage="İnşaatçılar m/s, 20 yanvar m/s, M.Əcəmi m/s, Nəsimi m/s,
              ...
              <div className="Tariffs-card">
                <h3>
                  <FormattedMessage
                    id="tariffs.zone3.header"
                    defaultMessage="Zona 3."
                  />
                </h3>
                <p>
                  <FormattedMessage
                    id="tariffs.zone3.text"
                    defaultMessage="Q.Qarayev m/s, Neftçilər m/s, X.Dostluğu m/s, H.Aslanov m/s
              ...
              <div className="Tariffs-card">
                <h3>
                  <FormattedMessage
                    id="tariffs.zone4.header"
                    defaultMessage="Zona 4."
                  />
                </h3>
                <p>
                  <FormattedMessage
                    id="tariffs.zone4.text"
                    defaultMessage="Buzovna, Mərdəkan, Şüvəlan, Albalılı, Qala, Zirə, Türkan,
              ...
              <div className="Tariffs-card">
                <h3>
                  <FormattedMessage
                    id="tariffs.zone5.header"
                    defaultMessage="Zona 5."
                  />
                </h3>
                <p>
                  <FormattedMessage
                    id="tariffs.zone5.text"
                    defaultMessage="Naxçıvan Muxtar Respublikasının şəhər və rayonları"
                  />
                </p>
              </div>
              <div className="Tariffs-card">
                <h3>
                  <FormattedMessage
                    id="tariffs.zone6.header"
                    defaultMessage="Zona 6."
                  />
                </h3>
                <p>
                  <FormattedMessage
                    id="tariffs.zone6.text"
                    defaultMessage="Neftçala, Salyan, Şirvan, Hacıqabul, Mərəzə, Şamaxı, Qobustan,
              ...
              <div className="Tariffs-card">
                <h3>
                  <FormattedMessage
                    id="tariffs.zone7.header"
                    defaultMessage="Zona 7."
                  />
                </h3>
                <p>
                  <FormattedMessage
                    id="tariffs.zone7.text"
                    defaultMessage="Azərbaycan Respublikasının digər şəhər və rayonları
